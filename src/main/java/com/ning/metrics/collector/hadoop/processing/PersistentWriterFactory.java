...
public interface PersistentWriterFactory
{
     ...
     * @param fileExtension serializationType-specific file extension
     * @return eventWriter specific to an event type and serialization type
     */
    EventWriter createPersistentWriter(final WriterStats stats, final EventSerializer serializer, final String path, final String fileExtension);
}

...
public class TestSmileBodyResource extends TestResources<BodyResource>
{
    protected TestSmileBodyResource()
    {
        super(DeserializationType.SMILE);
    }
    ...
    {
        return resource.postSmile(Mockito.mock(InputStream.class), httpHeaders, request);
    }
}

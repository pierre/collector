...
More detailed documentation can be found {here}[http://pierre.github.com/collector.html].

== Download

Self contained artifacts can be found at {Maven Central}[http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.ning%22%20AND%20a%3A%22metrics.collector%22] (look for the jar-with-dependencies.jar artifact).
...
See {CollectorConfig.java}[https://github.com/pierre/collector/blob/master/src/main/java/com/ning/metrics/collector/binder/config/CollectorConfig.java] for configuration options.

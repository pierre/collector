/**
 * SystemStatisticsGlobalHostStatistics.java
 *
...
public class SystemStatisticsGlobalHostStatistics  implements java.io.Serializable {
    private iControl.CommonStatistic[] statistics;

    private iControl.CommonTimeStamp time_stamp;

    public SystemStatisticsGlobalHostStatistics() {
    }
    ...
    /**
     * Gets the statistics value for this SystemStatisticsGlobalHostStatistics.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this SystemStatisticsGlobalHostStatistics.
     * 
     * @param statistics
     */
    ...
    /**
     * Gets the time_stamp value for this SystemStatisticsGlobalHostStatistics.
     * 
     * @return time_stamp
     */
    ...
    /**
     * Sets the time_stamp value for this SystemStatisticsGlobalHostStatistics.
     * 
     * @param time_stamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SystemStatisticsGlobalHostStatistics)) return false;
        SystemStatisticsGlobalHostStatistics other = (SystemStatisticsGlobalHostStatistics) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SystemStatisticsGlobalHostStatistics.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "System.Statistics.GlobalHostStatistics"));

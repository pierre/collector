...
public class LocalLBRateClassRateUnit  implements java.io.Serializable {
    ...
    private iControl.LocalLBRateClassUnitType unit;
    ...
    public LocalLBRateClassRateUnit(
           long rate,
           iControl.LocalLBRateClassUnitType unit) {
           this.rate = rate;
           this.unit = unit;
    }
     ...
     * @return unit
     */
    public iControl.LocalLBRateClassUnitType getUnit() {
        return unit;
    }
     ...
     * @param unit
     */
    public void setUnit(iControl.LocalLBRateClassUnitType unit) {
        this.unit = unit;
    }

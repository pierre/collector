...
public class LocalLBPoolMemberMemberObjectStatus  implements java.io.Serializable {
    ...
    private iControl.LocalLBObjectStatus object_status;
    ...
    public LocalLBPoolMemberMemberObjectStatus(
           ...
           iControl.LocalLBObjectStatus object_status) {
           this.member = member;
     ...
     */
    public iControl.LocalLBObjectStatus getObject_status() {
        return object_status;
    }
     ...
     * @param object_status
     */
    public void setObject_status(iControl.LocalLBObjectStatus object_status) {
        this.object_status = object_status;
    }

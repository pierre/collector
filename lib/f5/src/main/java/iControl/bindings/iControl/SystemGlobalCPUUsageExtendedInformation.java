/**
 * SystemGlobalCPUUsageExtendedInformation.java
 *
...
public class SystemGlobalCPUUsageExtendedInformation  implements java.io.Serializable {
    private iControl.CommonStatistic[] statistics;

    private iControl.CommonTimeStamp time_stamp;

    public SystemGlobalCPUUsageExtendedInformation() {
    }
    ...
    /**
     * Gets the statistics value for this SystemGlobalCPUUsageExtendedInformation.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this SystemGlobalCPUUsageExtendedInformation.
     * 
     * @param statistics
     */
    ...
    /**
     * Gets the time_stamp value for this SystemGlobalCPUUsageExtendedInformation.
     * 
     * @return time_stamp
     */
    ...
    /**
     * Sets the time_stamp value for this SystemGlobalCPUUsageExtendedInformation.
     * 
     * @param time_stamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SystemGlobalCPUUsageExtendedInformation)) return false;
        SystemGlobalCPUUsageExtendedInformation other = (SystemGlobalCPUUsageExtendedInformation) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SystemGlobalCPUUsageExtendedInformation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "System.GlobalCPUUsageExtendedInformation"));

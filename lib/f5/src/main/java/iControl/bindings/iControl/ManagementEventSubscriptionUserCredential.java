...
public class ManagementEventSubscriptionUserCredential  implements java.io.Serializable {
    private iControl.ManagementEventSubscriptionAuthenticationMode auth_mode;
    ...
    public ManagementEventSubscriptionUserCredential(
           iControl.ManagementEventSubscriptionAuthenticationMode auth_mode,
     ...
     * @return auth_mode
     */
    public iControl.ManagementEventSubscriptionAuthenticationMode getAuth_mode() {
        return auth_mode;
    }
     ...
     * @param auth_mode
     */
    public void setAuth_mode(iControl.ManagementEventSubscriptionAuthenticationMode auth_mode) {
        this.auth_mode = auth_mode;
    }

...
public class SystemDiskUsageInformation  implements java.io.Serializable {
    private iControl.SystemDiskUsage[] usages;
    ...
    public SystemDiskUsageInformation(
           iControl.SystemDiskUsage[] usages,
     ...
     * @return usages
     */
    public iControl.SystemDiskUsage[] getUsages() {
        return usages;
    }
     ...
     * @param usages
     */
    public void setUsages(iControl.SystemDiskUsage[] usages) {
        this.usages = usages;
    }

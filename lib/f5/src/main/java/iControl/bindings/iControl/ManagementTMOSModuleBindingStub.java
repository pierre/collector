/**
 * ManagementTMOSModuleBindingStub.java
 *
...
public class ManagementTMOSModuleBindingStub extends org.apache.axis.client.Stub implements iControl.ManagementTMOSModulePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("get_descriptive_name");
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("get_known_module_list");
        oper.setReturnType(new javax.xml.namespace.QName("urn:iControl", "Common.TMOSModuleSequence"));
        oper.setReturnClass(iControl.CommonTMOSModule[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
    ...
    public ManagementTMOSModuleBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ManagementTMOSModuleBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ManagementTMOSModuleBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String[] get_descriptive_name(iControl.CommonTMOSModule[] modules) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:iControl:Management/TMOSModule");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:iControl:Management/TMOSModule", "get_descriptive_name"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {modules});
  ...
  throw axisFaultException;
    ...
    public iControl.CommonTMOSModule[] get_known_module_list() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:iControl:Management/TMOSModule");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:iControl:Management/TMOSModule", "get_known_module_list"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (iControl.CommonTMOSModule[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (iControl.CommonTMOSModule[]) org.apache.axis.utils.JavaUtils.convert(_resp, iControl.CommonTMOSModule[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public java.lang.String get_version() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:iControl:Management/TMOSModule");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:iControl:Management/TMOSModule", "get_version"));

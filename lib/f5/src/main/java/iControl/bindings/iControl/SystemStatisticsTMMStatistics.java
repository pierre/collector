...
public class SystemStatisticsTMMStatistics  implements java.io.Serializable {
    private iControl.SystemStatisticsTMMStatisticEntry[] statistics;
    ...
    public SystemStatisticsTMMStatistics(
           iControl.SystemStatisticsTMMStatisticEntry[] statistics,
     ...
     * @return statistics
     */
    public iControl.SystemStatisticsTMMStatisticEntry[] getStatistics() {
        return statistics;
    }
     ...
     * @param statistics
     */
    public void setStatistics(iControl.SystemStatisticsTMMStatisticEntry[] statistics) {
        this.statistics = statistics;
    }

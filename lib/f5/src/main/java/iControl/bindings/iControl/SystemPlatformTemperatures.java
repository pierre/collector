...
public class SystemPlatformTemperatures  implements java.io.Serializable {
    private iControl.SystemTemperatureMetric[][] temperatures;
    ...
    public SystemPlatformTemperatures(
           iControl.SystemTemperatureMetric[][] temperatures,
     ...
     * @return temperatures
     */
    public iControl.SystemTemperatureMetric[][] getTemperatures() {
        return temperatures;
    }
     ...
     * @param temperatures
     */
    public void setTemperatures(iControl.SystemTemperatureMetric[][] temperatures) {
        this.temperatures = temperatures;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTemperatures() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTemperatures(), i);
                if (obj != null &&

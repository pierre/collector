...
public class SystemTemperatureMetric  implements java.io.Serializable {
    private iControl.SystemTemperatureMetricType metric_type;
    ...
    public SystemTemperatureMetric(
           iControl.SystemTemperatureMetricType metric_type,
           long value) {
     ...
     * @return metric_type
     */
    public iControl.SystemTemperatureMetricType getMetric_type() {
        return metric_type;
    }
     ...
     * @param metric_type
     */
    public void setMetric_type(iControl.SystemTemperatureMetricType metric_type) {
        this.metric_type = metric_type;
    }

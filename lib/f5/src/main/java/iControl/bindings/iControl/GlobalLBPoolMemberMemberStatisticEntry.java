/**
 * GlobalLBPoolMemberMemberStatisticEntry.java
 *
...
public class GlobalLBPoolMemberMemberStatisticEntry  implements java.io.Serializable {
    private iControl.CommonIPPortDefinition member;

    private iControl.CommonStatistic[] statistics;

    public GlobalLBPoolMemberMemberStatisticEntry() {
    }
    ...
    /**
     * Gets the member value for this GlobalLBPoolMemberMemberStatisticEntry.
     * 
     * @return member
     */
    ...
    /**
     * Sets the member value for this GlobalLBPoolMemberMemberStatisticEntry.
     * 
     * @param member
     */
    ...
    /**
     * Gets the statistics value for this GlobalLBPoolMemberMemberStatisticEntry.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this GlobalLBPoolMemberMemberStatisticEntry.
     * 
     * @param statistics
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GlobalLBPoolMemberMemberStatisticEntry)) return false;
        GlobalLBPoolMemberMemberStatisticEntry other = (GlobalLBPoolMemberMemberStatisticEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GlobalLBPoolMemberMemberStatisticEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "GlobalLB.PoolMember.MemberStatisticEntry"));

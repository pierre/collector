/**
 * GlobalLBVirtualServerVirtualServerStatisticEntry.java
 *
...
public class GlobalLBVirtualServerVirtualServerStatisticEntry  implements java.io.Serializable {
    private iControl.GlobalLBVirtualServerDefinition virtual_server;

    private iControl.CommonStatistic[] statistics;

    public GlobalLBVirtualServerVirtualServerStatisticEntry() {
    }
    ...
    /**
     * Gets the virtual_server value for this GlobalLBVirtualServerVirtualServerStatisticEntry.
     * 
    ...
    /**
     * Sets the virtual_server value for this GlobalLBVirtualServerVirtualServerStatisticEntry.
     * 
    ...
    /**
     * Gets the statistics value for this GlobalLBVirtualServerVirtualServerStatisticEntry.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this GlobalLBVirtualServerVirtualServerStatisticEntry.
     * 
     * @param statistics
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GlobalLBVirtualServerVirtualServerStatisticEntry)) return false;
        GlobalLBVirtualServerVirtualServerStatisticEntry other = (GlobalLBVirtualServerVirtualServerStatisticEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GlobalLBVirtualServerVirtualServerStatisticEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "GlobalLB.VirtualServer.VirtualServerStatisticEntry"));

...
public class LocalLBMonitorInstanceState  implements java.io.Serializable {
    private iControl.LocalLBMonitorInstance instance;

    private iControl.LocalLBMonitorInstanceStateType instance_state;
    ...
    public LocalLBMonitorInstanceState(
           iControl.LocalLBMonitorInstance instance,
           iControl.LocalLBMonitorInstanceStateType instance_state,
     ...
     * @return instance
     */
    public iControl.LocalLBMonitorInstance getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(iControl.LocalLBMonitorInstance instance) {
        this.instance = instance;
    }
     ...
     */
    public iControl.LocalLBMonitorInstanceStateType getInstance_state() {
        return instance_state;
    }
     ...
     */
    public void setInstance_state(iControl.LocalLBMonitorInstanceStateType instance_state) {
        this.instance_state = instance_state;
    }

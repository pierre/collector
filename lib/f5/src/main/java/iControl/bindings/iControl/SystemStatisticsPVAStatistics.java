...
public class SystemStatisticsPVAStatistics  implements java.io.Serializable {
    private iControl.SystemStatisticsPVAStatisticEntry[] statistics;
    ...
    public SystemStatisticsPVAStatistics(
           iControl.SystemStatisticsPVAStatisticEntry[] statistics,
     ...
     * @return statistics
     */
    public iControl.SystemStatisticsPVAStatisticEntry[] getStatistics() {
        return statistics;
    }
     ...
     * @param statistics
     */
    public void setStatistics(iControl.SystemStatisticsPVAStatisticEntry[] statistics) {
        this.statistics = statistics;
    }

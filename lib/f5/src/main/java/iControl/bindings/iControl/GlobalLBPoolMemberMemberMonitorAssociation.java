/**
 * GlobalLBPoolMemberMemberMonitorAssociation.java
 *
...
public class GlobalLBPoolMemberMemberMonitorAssociation  implements java.io.Serializable {
    private iControl.GlobalLBMonitorIPPort member;

    private iControl.GlobalLBMonitorRule monitor_rule;

    public GlobalLBPoolMemberMemberMonitorAssociation() {
    }
    ...
    /**
     * Gets the member value for this GlobalLBPoolMemberMemberMonitorAssociation.
     * 
     * @return member
     */
    ...
    /**
     * Sets the member value for this GlobalLBPoolMemberMemberMonitorAssociation.
     * 
     * @param member
     */
    ...
    /**
     * Gets the monitor_rule value for this GlobalLBPoolMemberMemberMonitorAssociation.
     * 
     * @return monitor_rule
     */
    ...
    /**
     * Sets the monitor_rule value for this GlobalLBPoolMemberMemberMonitorAssociation.
     * 
     * @param monitor_rule
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GlobalLBPoolMemberMemberMonitorAssociation)) return false;
        GlobalLBPoolMemberMemberMonitorAssociation other = (GlobalLBPoolMemberMemberMonitorAssociation) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GlobalLBPoolMemberMemberMonitorAssociation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "GlobalLB.PoolMember.MemberMonitorAssociation"));

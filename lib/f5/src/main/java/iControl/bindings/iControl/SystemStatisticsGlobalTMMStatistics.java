/**
 * SystemStatisticsGlobalTMMStatistics.java
 *
...
public class SystemStatisticsGlobalTMMStatistics  implements java.io.Serializable {
    private iControl.CommonStatistic[] statistics;

    private iControl.CommonTimeStamp time_stamp;

    public SystemStatisticsGlobalTMMStatistics() {
    }
    ...
    /**
     * Gets the statistics value for this SystemStatisticsGlobalTMMStatistics.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this SystemStatisticsGlobalTMMStatistics.
     * 
     * @param statistics
     */
    ...
    /**
     * Gets the time_stamp value for this SystemStatisticsGlobalTMMStatistics.
     * 
     * @return time_stamp
     */
    ...
    /**
     * Sets the time_stamp value for this SystemStatisticsGlobalTMMStatistics.
     * 
     * @param time_stamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SystemStatisticsGlobalTMMStatistics)) return false;
        SystemStatisticsGlobalTMMStatistics other = (SystemStatisticsGlobalTMMStatistics) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SystemStatisticsGlobalTMMStatistics.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "System.Statistics.GlobalTMMStatistics"));

/**
 * SystemStatisticsSystemStatistics.java
 *
...
public class SystemStatisticsSystemStatistics  implements java.io.Serializable {
    private iControl.CommonStatistic[] statistics;

    private iControl.CommonTimeStamp time_stamp;

    public SystemStatisticsSystemStatistics() {
    }
    ...
    /**
     * Gets the statistics value for this SystemStatisticsSystemStatistics.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this SystemStatisticsSystemStatistics.
     * 
     * @param statistics
     */
    ...
    /**
     * Gets the time_stamp value for this SystemStatisticsSystemStatistics.
     * 
     * @return time_stamp
     */
    ...
    /**
     * Sets the time_stamp value for this SystemStatisticsSystemStatistics.
     * 
     * @param time_stamp
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SystemStatisticsSystemStatistics)) return false;
        SystemStatisticsSystemStatistics other = (SystemStatisticsSystemStatistics) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SystemStatisticsSystemStatistics.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "System.Statistics.SystemStatistics"));

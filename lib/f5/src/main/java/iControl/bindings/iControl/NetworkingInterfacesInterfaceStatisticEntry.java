/**
 * NetworkingInterfacesInterfaceStatisticEntry.java
 *
...
public class NetworkingInterfacesInterfaceStatisticEntry  implements java.io.Serializable {
    private java.lang.String interface_name;

    private iControl.CommonStatistic[] statistics;

    public NetworkingInterfacesInterfaceStatisticEntry() {
    }
    ...
    /**
     * Gets the interface_name value for this NetworkingInterfacesInterfaceStatisticEntry.
     * 
    ...
    /**
     * Sets the interface_name value for this NetworkingInterfacesInterfaceStatisticEntry.
     * 
    ...
    /**
     * Gets the statistics value for this NetworkingInterfacesInterfaceStatisticEntry.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this NetworkingInterfacesInterfaceStatisticEntry.
     * 
     * @param statistics
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NetworkingInterfacesInterfaceStatisticEntry)) return false;
        NetworkingInterfacesInterfaceStatisticEntry other = (NetworkingInterfacesInterfaceStatisticEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NetworkingInterfacesInterfaceStatisticEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "Networking.Interfaces.InterfaceStatisticEntry"));

/**
 * LocalLBPoolMemberMemberStatisticEntry.java
 *
...
public class LocalLBPoolMemberMemberStatisticEntry  implements java.io.Serializable {
    private iControl.CommonIPPortDefinition member;

    private iControl.CommonStatistic[] statistics;

    public LocalLBPoolMemberMemberStatisticEntry() {
    }
    ...
    /**
     * Gets the member value for this LocalLBPoolMemberMemberStatisticEntry.
     * 
     * @return member
     */
    ...
    /**
     * Sets the member value for this LocalLBPoolMemberMemberStatisticEntry.
     * 
     * @param member
     */
    ...
    /**
     * Gets the statistics value for this LocalLBPoolMemberMemberStatisticEntry.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this LocalLBPoolMemberMemberStatisticEntry.
     * 
     * @param statistics
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LocalLBPoolMemberMemberStatisticEntry)) return false;
        LocalLBPoolMemberMemberStatisticEntry other = (LocalLBPoolMemberMemberStatisticEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LocalLBPoolMemberMemberStatisticEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "LocalLB.PoolMember.MemberStatisticEntry"));

/**
 * LocalLBProfileFastHttpProfileFastHttpStatisticEntry.java
 *
...
public class LocalLBProfileFastHttpProfileFastHttpStatisticEntry  implements java.io.Serializable {
    private java.lang.String profile_name;

    private iControl.CommonStatistic[] statistics;

    public LocalLBProfileFastHttpProfileFastHttpStatisticEntry() {
    }
    ...
    /**
     * Gets the profile_name value for this LocalLBProfileFastHttpProfileFastHttpStatisticEntry.
     * 
     * @return profile_name
     */
    ...
    /**
     * Sets the profile_name value for this LocalLBProfileFastHttpProfileFastHttpStatisticEntry.
     * 
     * @param profile_name
     */
    ...
    /**
     * Gets the statistics value for this LocalLBProfileFastHttpProfileFastHttpStatisticEntry.
     * 
     * @return statistics
     */
    ...
    /**
     * Sets the statistics value for this LocalLBProfileFastHttpProfileFastHttpStatisticEntry.
     * 
     * @param statistics
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LocalLBProfileFastHttpProfileFastHttpStatisticEntry)) return false;
        LocalLBProfileFastHttpProfileFastHttpStatisticEntry other = (LocalLBProfileFastHttpProfileFastHttpStatisticEntry) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LocalLBProfileFastHttpProfileFastHttpStatisticEntry.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iControl", "LocalLB.ProfileFastHttp.ProfileFastHttpStatisticEntry"));

...
public class SystemStatisticsLocator extends org.apache.axis.client.Service implements iControl.SystemStatistics {
 ...
 */
    ...
    public SystemStatisticsLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for SystemStatisticsPort
    private java.lang.String SystemStatisticsPort_address = "https://url_to_service";
    ...
    private java.lang.String SystemStatisticsPortWSDDServiceName = "System.StatisticsPort";

    public java.lang.String getSystemStatisticsPortWSDDServiceName() {
        return SystemStatisticsPortWSDDServiceName;
    }

    public void setSystemStatisticsPortWSDDServiceName(java.lang.String name) {
    ...
    public iControl.SystemStatisticsPortType getSystemStatisticsPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            iControl.SystemStatisticsBindingStub _stub = new iControl.SystemStatisticsBindingStub(portAddress, this);
    ...
    public void setSystemStatisticsPortEndpointAddress(java.lang.String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (iControl.SystemStatisticsPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                iControl.SystemStatisticsBindingStub _stub = new iControl.SystemStatisticsBindingStub(new java.net.URL(SystemStatisticsPort_address), this);
                _stub.setPortName(getSystemStatisticsPortWSDDServiceName());
                return _stub;
            }
        }
